...
#
# Created: Tue Jul  9 19:19:45 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(0, 40, 181, 27))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.findButton = QtGui.QPushButton(self.groupBox)
        self.findButton.setGeometry(QtCore.QRect(200, 40, 98, 27))
        self.findButton.setObjectName(_fromUtf8("findButton"))
        self.pushButton = QtGui.QPushButton(self.groupBox)
        self.pushButton.setGeometry(QtCore.QRect(200, 90, 98, 27))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.graphicsView_2 = QtGui.QGraphicsView(self.groupBox)
        self.graphicsView_2.setGeometry(QtCore.QRect(160, 90, 31, 31))
        self.graphicsView_2.setObjectName(_fromUtf8("graphicsView_2"))
        self.groupBox_2 = QtGui.QGroupBox(self.settingTab)
        self.groupBox_2.setGeometry(QtCore.QRect(349, 19, 281, 321))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.findButton.setText(_translate("MainWindow", "Find Sensor", None))
        self.pushButton.setText(_translate("MainWindow", "Pair", None))
